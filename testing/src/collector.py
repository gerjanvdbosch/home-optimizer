...
class Collector:
    ...
    def update_load(self):
        ...
        raw_grid = self.client.get_grid_power()  # BELANGRIJK: Import - Export (kan negatief zijn)
        ...
        self.context.current_grid = self._update_buffer(self.context.grid_buffer, raw_grid)
