...
class ThermostatSetpointPlanEvaluation(DomainModel):
    plan_name: str
...
class ThermostatSetpointMpcEvaluationResult(DomainModel):
    ...
    plan_results: list[ThermostatSetpointPlanEvaluation]
    recommended_plan: ThermostatSetpointPlanEvaluation
...
class ThermostatSetpointMpcClosedLoopStepResult(DomainModel):
    ...
    selected_plan_total_cost: float
...
class ThermostatSetpointMpcClosedLoopDayResult(DomainModel):
    ...
    predicted_room_temperature: NumericSeries
    chosen_switch_count: int
    minimum_applied_setpoint: float | None
    maximum_applied_setpoint: float | None
    first_switch_time: datetime | None
    last_switch_time: datetime | None
    dominant_plan_name: str | None
