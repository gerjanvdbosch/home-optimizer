    ...
    def plan(
        ...
        *,
        ...
        return MpcPlan(
            ...
            heating_explanation="Heating scheduled to prevent comfort-min violation at 18:00.",
            objective_breakdown=MpcObjectiveBreakdown(
                comfort_low=0.0,
                active_comfort_high=0.0,
        ...
        *,
        ...
        return MpcBacktestResult(
            ...
            historical_summary=MpcBacktestSummary(
                ...
                active_comfort_high_degree_minutes=0.0,
                passive_comfort_high_degree_minutes=1.2,
                starts_per_day=0.5,
                runtime_minutes=12,
